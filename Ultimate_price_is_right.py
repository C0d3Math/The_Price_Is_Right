...
if game == 1:
    ...
    if pair1 != pair3 and pair2 != pair3:
        pair3matchey = True
    furniture_set = random.choice (["bedroom set that includes a bed with 3 pillows, a lampstand, a penlight, and a Kindle","kitchen set that includes a electric range, a microwave oven, and a dishwasher","a patio set that includes 3 couches, 2 chairs, a tabel, and 2 patio heaters"])
    print("You can win a " + str(furniture_set) + " in Pick A Pair!")
